...
/** หลักสูตรสอบ คร. 9 บท (Aj 2026-08-21): บทที่ 1 = ความรู้เกี่ยวกับกรมควบคุมโรค
 *  แล้วต่อด้วย 8 เรื่อง "ตามลำดับประกาศรับสมัคร" ข้อ 5.1–5.8 เป็นบทที่ 2–9
...
export const DCD_SYLLABUS: { no: number; short: string; full: string }[] = [
  { no: 1, short: "ความรู้เกี่ยวกับกรมควบคุมโรค",
    full:  "ความรู้เกี่ยวกับกรมควบคุมโรค — วิสัยทัศน์ พันธกิจ โครงสร้าง ภารกิจ และค่านิยมองค์กร" },
  { no: 2, short: "พ.ร.บ.การสาธารณสุข พ.ศ. 2535",
    full:  "พระราชบัญญัติการสาธารณสุข พ.ศ. 2535 และที่แก้ไขเพิ่มเติม (ฉบับล่าสุด)" },
  { no: 3, short: "พ.ร.บ.ควบคุมเครื่องดื่มแอลกอฮอล์ พ.ศ. 2551",
    full:  "พระราชบัญญัติควบคุมเครื่องดื่มแอลกอฮอล์ พ.ศ. 2551 และ (ฉบับที่ 2) พ.ศ. 2568" },
  { no: 4, short: "พ.ร.บ.โรคติดต่อ พ.ศ. 2558",
    full:  "พระราชบัญญัติโรคติดต่อ พ.ศ. 2558" },
  { no: 5, short: "พ.ร.บ.ควบคุมผลิตภัณฑ์ยาสูบ พ.ศ. 2560",
    full:  "พระราชบัญญัติควบคุมผลิตภัณฑ์ยาสูบ พ.ศ. 2560" },
  { no: 6, short: "พ.ร.บ.ควบคุมโรคจากการประกอบอาชีพฯ พ.ศ. 2562",
    full:  "พระราชบัญญัติควบคุมโรคจากการประกอบอาชีพและโรคจากสิ่งแวดล้อม พ.ศ. 2562" },
  { no: 7, short: "ระบาดวิทยา สถิติ และการจัดการข้อมูล",
    full:  "หลักระบาดวิทยา หลักสถิติเบื้องต้น การรวบรวมข้อมูล วิเคราะห์ และการนำเสนอข้อมูล (การจัดการข้อมูล/สารสนเทศ)" },
  { no: 8, short: "โรคติดต่อ/ไม่ติดต่อ และการเฝ้าระวัง สอบสวน ควบคุมโรค",
  ...
  { no: 9, short: "การสื่อสารความเสี่ยงด้านสุขภาพ",
